...
Deborah Anderson, for her much needed expertise and review \\
Norman de los Santos, for his kind support of this proposal and thoughts} \\
\symbol{"200C}\\
\ra\ra\ra\ra \\
\symbol{"200C}\\
...
\begin{enumerate}
    \item Generic --- \ra
    \item Generic, longer stroke --- {\baybayinb \symbol{"E006}}
    \item Rizaleo --- \rizaleoRA
    \item Bikol --- {\baybayinb \symbol{"E004}}
    \item Applied to a cursive {\baybayinb \symbol{"E007}} --- {\baybayinb \symbol{"E008}}
    \item\label{DoubleLoop} Double cursive loop --- {\baybayinb \symbol{"E009}}
\end{enumerate}
